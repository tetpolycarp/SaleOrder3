                  ...
                  <td>
                       <div id="div_print_pickupdate">
                         <table style="width: 100%;">      
                             ...
                             <td align="left">
                                 <asp:RadioButtonList ID="RadioButtonListInvoiceType" runat="server" Enabled="true" OnSelectedIndexChanged="RadioButtonListInvoiceType_SelectedIndexChanged1" AutoPostBack="true">
                  ...
                  <td align="right" style= "border: solid #0040ff medium; ">
                        <div id="div_print_invoicenumber">
                         ...
                         <tr>
                             ...
                             <td align="left">
                             <asp:TextBox ID="TextBoxInvoiceNumber" Width="90%" runat="server" Enabled="false" BorderStyle="None"></asp:TextBox>
                                 </td>
                         </tr>
                          <tr>
                              <td  align="right">
                             ...
                             <td align="left">
                             <asp:TextBox ID="TextBoxInvoiceDate" Width="90%" runat="server" Enabled="false" BorderStyle="None"></asp:TextBox>
                              </td>
                          </tr>
                               <tr>
                              <td  align="right">
                             ...
                             <td align="left">
                             <asp:TextBox ID="TextBoxCreatedBy" Width="90%" runat="server" Enabled="false" BorderStyle="None"></asp:TextBox>
                              </td>
                          </tr>
                              <tr>
                              <td  align="right">
                             ...
                             <td align="left">
                             <asp:TextBox ID="TextBoxLastUpdatedBy" Width="90%" runat="server" Enabled="false" BorderStyle="None"></asp:TextBox>
                              </td>
                          </tr>
                             <tr><td  align="right">
                             ...
                             <td align="left">
                                        <asp:TextBox ID="TextBoxInvoiceStatus" Width="90%" runat="server" Enabled="false" BorderStyle="None"></asp:TextBox>
                                 </td>
                             </tr>
                             <tr><td></td><td></td></tr>
             ...
             <Columns>
                    ...
                    <ItemStyle HorizontalAlign="Center"></ItemStyle>
                      ...
                      <telerik:GridTemplateColumn HeaderButtonType="TextButton" HeaderText="Sale Item" UniqueName="SaleItem" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="20%" >  
                              <HeaderStyle Font-Bold="True" Font-Size="" />        
                                    <ItemTemplate> 
                                        <asp:DropDownList ID="DropDownListSaleItem" Enabled="true" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownListSaleItem_SelectedIndexChanged" Font-Bold="True" Font-Size="Large" style="text-align: left" Width="80%"></asp:DropDownList>
                                    </ItemTemplate> 

<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                </telerik:GridTemplateColumn> 
                    <telerik:GridTemplateColumn HeaderButtonType="TextButton" HeaderText="Quantity" UniqueName="Quantity" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" >  
                              <HeaderStyle Font-Bold="True" Font-Size="" />        
                                    <ItemTemplate> 
                                        <asp:TextBox ID="TextBoxQuantity" Enabled="true" runat="server" AutoPostBack="true" OnTextChanged="TextBoxQuantity_TextChanged" Font-Bold="True" Font-Size="Large" style="text-align: right" Width="80%">
                                        </asp:TextBox>
                                    </ItemTemplate> 

<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                </telerik:GridTemplateColumn> 
                   <telerik:GridTemplateColumn HeaderButtonType="TextButton" HeaderText="Unit Price" UniqueName="UnitPrice" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="7%" >  
                              <HeaderStyle Font-Bold="True" Font-Size="" />        
                                    <ItemTemplate>  
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                 ...
                 <telerik:GridTemplateColumn HeaderButtonType="TextButton" HeaderText="Discount Per Unit" UniqueName="Discount" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="10%" >  
                              <HeaderStyle Font-Bold="True" Font-Size="" />        
                                    <ItemTemplate> 
                                        <asp:TextBox ID="TextBoxDiscount" runat="server" Enabled="false" AutoPostBack="true" OnTextChanged="TextBoxDiscount_TextChanged" Font-Bold="True" Font-Size="Large" style="text-align: right" Width="80%">
                                        </asp:TextBox>
                                    </ItemTemplate> 
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                            ...
                            <telerik:GridTemplateColumn HeaderButtonType="TextButton" HeaderText="Packed" UniqueName="Packed" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="1%" >  
        <HeaderStyle Font-Bold="True" Font-Size="" />        
              <ItemTemplate> 
                  <asp:ImageButton ID="ImageButtonPacked" runat="server" ImageUrl="~/images/pickedup_yes.png" Width="22px" Height="22px" OnClick="ImageButtonPacked_Click" Enabled="false" Visible="false" />
                  <asp:ImageButton ID="ImageButtonNotPacked" runat="server" ImageUrl="~/images/pickedup_no.png" Width="20px" Height="20px" OnClick="ImageButtonNotPacked_Click" Enabled="false" Visible="false"  />
              </ItemTemplate> 
                  ...
                  <table>
                      <tr>
                           ...
                           <td align="center" valign="middle">
                                 <table style="width: 100%;">
                                               <tr>
                                                               <td>    <asp:Button ID="ButtonPickupAll" runat="server" Text="Pickup All" Width="150px" OnClick="ButtonPickupAll_Click" ForeColor="White" BackColor="Black" Font-Bold="true" BorderWidth="5" BorderStyle="Double" BorderColor="Blue"/> &emsp; </td>
                                                 <td>    <asp:Button ID="ButtonPaidAll" runat="server" Text="Paid All" Width="150px" OnClick="ButtonPaidAll_Click" ForeColor="White" BackColor="Black" Font-Bold="true" BorderWidth="5" BorderStyle="Double" BorderColor="Red" /> &emsp; </td>
                                                    <td>    | &emsp; </td>
                                             ...
                                             <td>    | &emsp; </td>
                                                   <td>    <asp:Button ID="ButtonPackAll" runat="server" Text="Pack All" Width="150px"  OnClick="ButtonPackAll_Click" ForeColor="White" BackColor="SteelBlue" BorderStyle="Double" BorderColor="Blue" /> &emsp; </td>
                                                   <td>    <asp:Button ID="ButtonRefreshPage" runat="server" Text="Update Page" Width="150px"  OnClick="ButtonRefreshPage_Click" ForeColor="White" BackColor="SteelBlue" BorderStyle="Double" BorderColor="Blue" /> &emsp; </td>  
